<script lang="ts">
	...
	import GeneralSettings from "$lib/components/app-ui/settings/GeneralSettings.svelte";
	import EQSettings from "$lib/components/app-ui/settings/EQSettings.svelte";
	import LocalMetadataSettings from "$lib/components/app-ui/settings/LocalMetadataSettings.svelte";
	import ScanSettings from "$lib/components/app-ui/settings/ScanSettings.svelte";
	import AccountsSettings from "$lib/components/app-ui/settings/AccountsSettings.svelte";
	import MetadataAPISettings from "$lib/components/app-ui/settings/MetadataAPISettings.svelte";
	import DownloadsSettings from "$lib/components/app-ui/settings/DownloadsSettings.svelte";
