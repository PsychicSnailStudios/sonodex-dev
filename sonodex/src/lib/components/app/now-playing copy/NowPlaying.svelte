<script lang="ts">
   ...
   import TrackContext from "$lib/components/app-ui/context-menus/TrackContext.svelte";
	...
	import { currentlyPlaying, clearQueue, getQueuedTracks, player, getPlayedTracks, addTrackToQueue } from "$lib/ts/audio/audioManager.svelte";
		...
		<Tabs.Root value="queue">
			...
			<Tabs.Content value="queue">
				...
				<ContextMenu.Root>
					...
					<TrackContext track={player.track!} />
				</ContextMenu.Root>
